...
// /browser compatibility
  ...
  var Kmeans = function(observations, k) {
    ...
    this._k = k || 3;
    this._iterations = []; // collection of iteration objects {means: [], clusters: [], variances: []} (todo: refactor into cluster object)
  }
  ...
  Kmeans.prototype = {
    ...
    _iterate: function() {
      ...
      for(var i in clusters) {
        ...
        var mean = means[i];
        var variance = vector(mean).getVariance(cluster);
